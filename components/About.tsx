          ...
          >
            ...
            <div className="relative rounded-3xl overflow-hidden aspect-[4/5] md:aspect-[3/4] lg:h-[560px] shadow-card-hover">
              ...
              <div className="absolute bottom-6 left-6 z-10">
                <span className="inline-block font-body text-[10px] font-bold tracking-[0.18em] uppercase text-teal-300 bg-navy/70 backdrop-blur-sm px-3.5 py-1.5 rounded-full border border-white/10">
                  Est. 1998 · Rye, NH
                </span>
              </div>
            </div>
            ...
            <motion.div
              ...
              className="absolute -top-4 -right-2 md:-right-6 bg-white rounded-2xl px-5 py-4 shadow-card-hover border border-slate-100"
            >
              <p className="font-display text-3xl font-bold text-teal-600 leading-none">40+</p>
              <p className="font-body text-xs text-slate-500 mt-1">Rotating Flavors</p>
            </motion.div>
          </motion.div>
          ...
          >
            <div>
              <div className="inline-flex items-center gap-3 mb-6">
                ...
                <span className="font-body text-xs font-bold tracking-[0.15em] uppercase text-teal-600">
                  Our Story
                </span>
              </div>
              ...
              <blockquote className="relative">
                <span
                  className="absolute -top-4 -left-3 font-display font-bold text-teal-100 select-none leading-none"
                  style={{ fontSize: '5rem' }}
                  aria-hidden="true"
                >
                  &ldquo;
                ...
                <p
                  className="font-display font-bold text-slate-900 leading-[1.15] tracking-tight relative z-10"
                  style={{ fontSize: 'clamp(1.5rem, 3.5vw, 2.25rem)' }}
                >
                  We&apos;ve been scooping since before you could{' '}
                  <span className="text-teal-600">Google us.</span>
                </p>
              </blockquote>

              <div className="flex items-center gap-3 mt-6" aria-hidden="true">
                <div className="w-10 h-[3px] rounded-full bg-teal-600" />
                <div className="w-4 h-[3px] rounded-full bg-coral" />
                <div className="w-2 h-[3px] rounded-full bg-coral/40" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3 pt-2">
              {stats.map(({ stat, label }) => (
                <div
                  key={label}
                  className="flex flex-col items-center text-center bg-white rounded-2xl py-4 px-2 shadow-card border border-slate-100 hover:shadow-card-hover transition-shadow duration-200"
                >
                  <span className="font-display text-xl font-bold text-teal-600">{stat}</span>
                  <span className="font-body text-[11px] text-slate-400 mt-1">{label}</span>
                </div>
              ))}
            </div>
          </motion.div>
